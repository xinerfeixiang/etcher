...
exports.fromFlashState = (currentFlashState) => {
  ...
  if (!isChecking && currentFlashState.percentage === utils.PERCENTAGE_MINIMUM && !currentFlashState.speed) {
    subtitle = 'Starting...';

  } else if (isChecking && currentFlashState.percentage === utils.PERCENTAGE_MINIMUM && !currentFlashState.speed) {
    subtitle = 'Validating...';
