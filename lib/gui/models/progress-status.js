 ...
 *
 * @example
 * const fullStatus = progressStatus.makeSubtitle({
 *   type: 'write',
 *   percentage: 55,
 *   speed: 2049
 * });
 */
exports.makeSubtitle = (currentFlashState) => {
...
exports.makeTitle = (baseTitle, currentFlashState) => {
  const subtitle = exports.makeSubtitle(currentFlashState);
