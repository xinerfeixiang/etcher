...
describe('Shared: GitHub Releases', function() {
  ...
  describe('.getLatestVersion()', function() {
    ...
    describe('given a single final release', function() {
      ...
      it('should resolve the version if includeUnstableChannel is true', function(done) {
      ...
      it('should resolve the version if includeUnstableChannel is false', function(done) {
        githubReleases.getLatestVersion({
      ...
      it('should resolve the version if includeUnstableChannel is not passed', function(done) {
        githubReleases.getLatestVersion().then((latestVersion) => {
          m.chai.expect(latestVersion).to.equal('0.5.0');
          done();
        }).catch(done);
    ...
    describe('given a single pre-release', function() {
      ...
      it('should resolve undefined if includeUnstableChannel is not passed', function(done) {
        githubReleases.getLatestVersion().then((latestVersion) => {
          m.chai.expect(latestVersion).to.be.undefined;
          done();
        }).catch(done);
